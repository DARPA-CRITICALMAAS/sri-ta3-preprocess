...
1. Gather / load all vector (.shp) and raster (.tif) data relevant to the experiment
2. Define bounds - choose the max size (left-most, right-most, top-most, bottom-most) bound for all vector and raster files
